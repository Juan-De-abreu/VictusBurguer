      ...
      <>
        ...
        <div className="lg:hidden min-h-screen bg-gradient-to-br from-gray-900/20 to-black relative overflow-hidden">
          ...
          <div className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-70" 
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-black/30 via-black/50 to-black/60 backdrop-blur-sm h-auto" />
          </div>
        ...
        {/* Desktop: Layout ORIGINAL con grid 2 columnas + animaciones */}
        <div className="hidden lg:grid lg:grid-cols-2 lg:h-screen lg:min-h-screen bg-gradient-to-br from-gray-900/20 to-black transition-all duration-700 ease-in-out">
          {/* DIV 1 - Imagen: Cambia posición según formulario */}
          <div className={`
          ...
          `}>
            <div className="absolute inset-0 bg-cover bg-center bg-no-repeat opacity-70" 
                style={{ backgroundImage: "url('/src/assets/img/FondoLogin.png')" }} />
            <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/40 to-black/90 backdrop-blur-sm inset-shadow-red-900 inset-shadow-sm" />
            <div className="relative z-10 flex flex-col items-center justify-center h-full p-12 text-white text-center">
              <div className="w-full max-w-sm animate-float">
                <h2 className="text-4xl font-black bg-[var(--segundario)] bg-clip-text text-transparent drop-shadow-2xl mb-4">
                  Victu's Burgers
                </h2>
                <p className="text-xl text-white/90 max-w-sm leading-relaxed drop-shadow-lg px-2">
                  {isLogin 
                    ? "Accede a tu cuenta" 
          ...
          {/* DIV 2 - Formulario: Cambia posición + redondeo superior */}
          <div className={`
            bg-[var(--body)] shadow-2xl shadow-red-900/50 w-full flex flex-col items-center justify-center p-12 relative z-10
            ${isLogin 
              ? 'lg:order-2 rounded-t-3xl' 
              : 'lg:order-1 rounded-t-3xl'
            }
            ${isTransitioning ? 'animate-slide-right lg:animate-slide-left' : ''}
          `}>
            <div className="w-full max-w-lg xl:max-w-xl mx-auto h-fit max-h-auto flex flex-col lg:mt-10">
              {/* Header */}
              <div className="text-center mb-6 flex-shrink-0 pt-12">
