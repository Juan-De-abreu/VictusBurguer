    ...
    <>
      ...
      <section className="relative bg-gradient-to-b from-gray-900/90 to-black/90 overflow-hidden h-[70vh] sm:h-[80vh] md:h-screen max-h-[600px] lg:max-h-[700px] flex items-center justify-center px-4">
        ...
        <div className="relative z-20 text-center text-white max-w-5xl mx-auto px-4">
          <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-serif italic mb-4 md:mb-6 drop-shadow-2xl leading-tight">
          ...
          <p className="text-lg sm:text-xl md:text-2xl mb-8 md:mb-12 font-light drop-shadow-lg max-w-2xl mx-auto leading-relaxed">
            Es lo mejor para empezar tu día con un café. Descubre los mejores cafés que hemos preparado.
          </p>
